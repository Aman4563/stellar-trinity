...
class AttestationFailureReason(StrEnum):
    ...
    EXECUTION_PREDICATE_VERSION_UNSUPPORTED = "execution_predicate_version_unsupported"
    EXECUTION_HARNESS_CONFIG_DIVERGENT = "execution_harness_config_divergent"
    EXECUTION_ROSTER_UNBOUND = "execution_roster_unbound"
    EXECUTION_CAPTURE_UNBOUND = "execution_capture_unbound"
    EXECUTION_TELEMETRY_INCONSISTENT = "execution_telemetry_inconsistent"
    EXECUTION_DIAGNOSIS_ONLY = "execution_diagnosis_only"
