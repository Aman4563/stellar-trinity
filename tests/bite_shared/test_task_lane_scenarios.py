...
from tests.test_layout import make_layout_parent
...
@bite("shared.md:R14")
def test_a_surviving_deliverables_root_holds_at_retired_root(
    ...
    assert [item.code for item in findings] == [layout.PARENT_LAYOUT_RETIRED_ROOT]
