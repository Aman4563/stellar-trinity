---
description: Run the ENGRAM case-study interview elicitation rounds.
---

Read `trinity/ENGRAM.md` and run the Phase S step 20a interview elicitation rounds. Operate from the parent project root, resolve every bare path there, and follow the contract end to end; this door defers to it, adds nothing to it, and restates none of it.
